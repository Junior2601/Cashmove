...
// Route admin seulement pour voir par méthode de paiement
router.get("/payment-method/:payment_method_id", verifyToken, authorizeRoles("admin"), controller.getAuthorizedNumbersByPaymentMethod);
