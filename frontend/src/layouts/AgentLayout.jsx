...
import {
  ...
  LayoutDashboard, ArrowLeftRight, Redo2, CircleFadingPlus, Phone
} from 'lucide-react';
...
export default function AgentLayout() {
  ...
  const menuItems = [
    ...
    { path: '/agent/create',     label: 'Créer Transfert',      icon: CircleFadingPlus          },
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-slate-50 to-emerald-50/30">
        ...
        <div className="flex justify-between items-center mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">Gestion des opérations</p>
            </div>
          </div>
          <button
            onClick={() => setSidebarOpen(false)}
